...
import { CreditCard, CrownIcon, Zap } from 'lucide-react'
import Link from 'next/link'
import React from 'react'

import { useGetMeQuery } from '@/api/hooks/useGetMeQuery'
import { useToggleAutoRenewalMutation } from '@/api/hooks/useToggleAutoRenewalMutation'
import { SubscriptionResponseStatus } from '@/api/types'

import SubscriptionStatusBadge from '@/components/settings/badges'
		...
		>
			...
			<div className='border-t pt-4'>
				<div className='flex items-center gap-2'>
					...
					<span className='text-sm font-semibold'>Автоплатеж</span>
				</div>
