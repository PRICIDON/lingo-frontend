...
import { getPaymentById } from '@/api/requests/payment'
						...
						<div className='rounded-lg bg-gray-50 p-4 text-left'>
							...
							<div className='mb-6 space-y-1 text-sm text-gray-600'>
								<div className='flex justify-between'>
									<span className=''>Тариф:</span>
									<span className='font-medium'>
										{plan.title}
									</span>
								</div>
								<div className='flex justify-between'>
									<span className=''>Стоимость:</span>
									<span className='font-medium'>
										{price}&#8381; / {periodShort}
									</span>
								</div>
								<div className='flex justify-between'>
									<span className=''>Период оплаты:</span>
									<span className='font-medium'>
										{period}
									</span>
								</div>
								<div className='flex justify-between'>
									<span className=''>ID транзакции:</span>
